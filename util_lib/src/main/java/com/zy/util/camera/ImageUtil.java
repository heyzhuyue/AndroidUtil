...
public final class ImageUtil {
     ...
     * @return
     */
    public static Uri file2Uri(@Nullable Context context, @Nullable File file) {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(Context context, final int id, final int maxWidth, final int maxHeight) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
